...
import injectJobsFromListIntoLookupDb from '@salesforce/apex/ApexJobActionController.injectJobsFromListIntoLookupDb';

const defaultButtonLabel = 'Bookmark Jobs';
const processingButtonLabel = 'Processing....';

export default class BookmarkJobsButton extends LightningElement {
    ...
    doAction() {
        injectJobsFromListIntoLookupDb({lstJobIds: this.selectedRecords, status: 'Bookmarked'})
        .then(result => {
