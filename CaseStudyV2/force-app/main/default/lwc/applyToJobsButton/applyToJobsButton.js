...
const defaultButtonLabel = 'Apply to Jobs';
const processingButtonLabel = 'Processing....';

export default class ApplyToJobsButton extends LightningElement {
    ...
    doAction() {
        injectJobsFromListIntoLookupDb({lstJobIds: this.selectedRecords, status: 'Applied'})
        .then(result => {
